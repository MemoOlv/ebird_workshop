...
RUN Rscript -e "install.packages(c('fields','rnaturalearth', 'rnaturalearthdata'), repos = 'http://cran.rstudio.com')"
...
RUN Rscript -e "install.packages('geodata'), repos = 'http://cran.rstudio.com')"
