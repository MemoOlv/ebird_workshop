...
ggsave("migration_chronology_hooded_warbler_guatemala.png")
# ├ Exercises ----
...
ggsave("migration_chronology_grassland_birds_montana.png")
...
png(filename="importance_map_grassland_birds_montana.png")
